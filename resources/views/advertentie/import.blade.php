...
<body>
    ...
    <div class="container">
        ...
        <p>Note: De import verwacht een .csv bestand met de kolommen "Titel", "Omschrijving", "Prijs", "Einddatum", "Type".</p> <br>
        <p>Note: De kolom "Type" wilt alleen de waardes accepteren 'verhuur' / 'verkoop' </p> <br>
